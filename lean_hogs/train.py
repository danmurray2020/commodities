"""Train and evaluate Lean Hogs price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("LEAN HOGS FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="lean_hogs_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="lean_hogs_clf")
    ...
    print("\n" + "=" * 60)
    print("LEAN HOGS 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["hogs_close"].values[0])
