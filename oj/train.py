"""Train and evaluate Orange Juice price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("ORANGE JUICE FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="oj_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="oj_clf")
    ...
    print("\n" + "=" * 60)
    print("ORANGE JUICE 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["oj_close"].values[0])
