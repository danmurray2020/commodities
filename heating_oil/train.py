"""Train and evaluate Heating Oil price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("HEATING OIL FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="heating_oil_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="heating_oil_clf")
    ...
    print("\n" + "=" * 60)
    print("HEATING OIL 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["heating_oil_close"].values[0])
