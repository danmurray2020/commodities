"""Train and evaluate Oats price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("OATS FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="oats_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="oats_clf")
    ...
    current_price = float(latest["oats_close"].values[0])
