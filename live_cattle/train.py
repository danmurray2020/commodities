"""Train and evaluate Live Cattle price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("LIVE CATTLE FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="live_cattle_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="live_cattle_clf")
    ...
    print("\n" + "=" * 60)
    print("LIVE CATTLE 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["cattle_close"].values[0])
