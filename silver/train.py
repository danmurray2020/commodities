"""Train and evaluate Silver price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("SILVER FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="silver_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="silver_clf")
    ...
    print("\n" + "=" * 60)
    print("SILVER 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["silver_close"].values[0])
