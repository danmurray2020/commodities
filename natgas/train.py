"""Train and evaluate natgas price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("NATURAL GAS FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="natgas_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="natgas_clf")
    ...
    # Prediction
    print("\n" + "=" * 60)
    print("NATURAL GAS 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
