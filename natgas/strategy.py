...
def run_strategy_backtest(config: TradeConfig = None):
    ...
    axes[2].plot(test_period.index, test_period["natgas_close"], linewidth=1, color="#71717a", alpha=0.7)
    for t in all_trades:
    ...
    axes[2].set_ylabel("Natural Gas Price ($/MMBtu)")
