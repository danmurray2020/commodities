"""Train and evaluate Cotton price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("COTTON FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="cotton_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="cotton_clf")
    ...
    print("\n" + "=" * 60)
    print("COTTON 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["cotton_close"].values[0])
