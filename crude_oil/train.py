"""Train and evaluate Crude Oil price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("CRUDE OIL FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="crude_oil_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="crude_oil_clf")
    ...
    print("\n" + "=" * 60)
    print("CRUDE OIL 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["crude_oil_close"].values[0])
