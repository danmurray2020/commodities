"""Train and evaluate Gasoline price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("GASOLINE FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="gasoline_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="gasoline_clf")
    ...
    print("\n" + "=" * 60)
    print("GASOLINE 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["gasoline_close"].values[0])
