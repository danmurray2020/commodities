"""Fetch Lumber futures data and supplementary market data."""
...
def main():
    ...
    prices = fetch_prices()
    prices.to_csv(DATA_DIR / "lumber_prices.csv")

    supplementary = fetch_supplementary_data()
    combined = prices[["Close"]].rename(columns={"Close": "lumber_close"})
