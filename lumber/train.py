"""Train and evaluate Lumber price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("LUMBER FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="lumber_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="lumber_clf")
    ...
    print("\n" + "=" * 60)
    print("LUMBER 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["lumber_close"].values[0])
