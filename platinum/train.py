"""Train and evaluate Platinum price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("PLATINUM FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="platinum_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="platinum_clf")
    ...
    print("\n" + "=" * 60)
    print("PLATINUM 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["platinum_close"].values[0])
