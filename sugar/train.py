"""Train and evaluate sugar price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("SUGAR FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="sugar_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="sugar_clf")
