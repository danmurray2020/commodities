"""Train and evaluate Corn price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("CORN FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="corn_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="corn_clf")
    ...
    current_price = float(latest["corn_close"].values[0])
