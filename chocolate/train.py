"""Train and evaluate cocoa price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("COCOA FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="cocoa_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="cocoa_clf")
