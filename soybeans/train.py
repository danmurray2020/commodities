"""Train and evaluate soybeans price prediction models."""
...
def main():
    ...
    print("=" * 60)
    print("SOYBEANS FUTURES PREDICTION MODEL")
    print("=" * 60)
    ...
    reg_study = optuna.create_study(direction="maximize", study_name="soybeans_reg")
    ...
    clf_study = optuna.create_study(direction="maximize", study_name="soybeans_clf")
    ...
    # Prediction
    print("\n" + "=" * 60)
    print("SOYBEANS 63-DAY PREDICTION")
    print("=" * 60)
    latest = df.iloc[[-1]]
    ...
    current_price = float(latest["soybeans_close"].values[0])
